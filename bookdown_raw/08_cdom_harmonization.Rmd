...
Next, we populate the miscellaneous flag (`misc_flag`) column. The miscellaneous flag is used in this dataset to mark measurements that exceed published maximum records based on a review of the relevant literature. We do this instead of filtering the records out, but a depth-related filter still occurs in the next harmonization step. Flag values of 1 = exceeds published value and 0 = does not exceed published value. Thresholds used and citations are below, followed by a table with counts by parameters, unit, and flag value:

| **Parameter** | **Units** | **Max value** | **Source** |
|---|---|---|---|
...
| Absorption spectral slope (multiple) | nm-1 | 0.0473 | Korak and McKay 2024 |
| FDOM | RU | 4.38 | Korak and McKay 2024 |
| FDOM | ug/L, ug/l QSE | 84.4 | Avouris et al. 2025 |
| Fluorescence index | None | 2.18 | Korak and McKay 2024 |
| SUVA | L/mgDOC*m | 6.83 | Korak and McKay 2024 |
