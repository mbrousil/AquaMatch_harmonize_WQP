...
Once ready for harmonization, the Water Color WQP dataset contains the following user-defined `CharacteristicNames`: `r tc_chars`.
...
In preparation for tiering, we check the `ResultAnalyticalMethod.MethodName` column for names that indicate non-Water Color measurements. 
...
<img src="3_harmonize/out/tc_tier_dists_location_postagg.png" alt="Distribution of Water Color values by location type" width="650"/>
...
<img src="3_harmonize/out/tc_tier_dists_postagg.png" alt="Distribution of Water Color values by tier" width="650"/>


<img src="3_harmonize/out/tc_tier_cv_dists_postagg.png" alt="Distribution of Water Color CVs by tier" width="650"/>

<br>

3. Maps showing the geographic distribution of records by tier within the US:

<img src="3_harmonize/out/tc_tier_hex_map.png" alt="Geographic distribution of Water Color records by tier in the conterminous US" width="650"/>

<br>

4. Bar charts showing the distribution of values by tier across years, months, and days of the week:

<img src="3_harmonize/out/tc_year_tier_chart.png" alt="Temporal distribution of Water Color records by tier across years" width="650"/>

<img src="3_harmonize/out/tc_month_tier_chart.png" alt="Temporal distribution of Water Color records by tier across months" width="650"/>

<img src="3_harmonize/out/tc_wday_tier_chart.png" alt="Temporal distribution of Water Color records by tier across days of the week" width="650"/>
