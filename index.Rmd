...
This bookdown documents the harmonization process for data downloaded from the [Water Quality Portal](https://www.waterqualitydata.us/wqp_description/) (Water Quality Portal, 2021; "WQP") used to build the AquaMatch dataset, a data product of AquaSat v2. The WQP is a data warehouse for water-related data measured or observed within the United States and US Territories managed by the Environmental Protection Agency (EPA), United States Geological Survey (USGS), and the National Water Quality Monitoring Council (NWQMC). AquaMatch collates water quality measurements and observations with optical and thermal satellite data from lakeSR and riverSR.
