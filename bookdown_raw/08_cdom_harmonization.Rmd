...
The next step in CDOM harmonization is converting the units of WQP records. Records that don't make sense for CDOM or can't be converted to mg per liter (mg/L) are dropped. We use the following unit conversion table for this:
...
+ **Have `[USGSPCode](https://help.waterdata.usgs.gov/codes-and-parameters/parameters)` or `ResultAnalyticalMethod.MethodName` values typical of CDOM or SSC (Suspended Sediment Concentration)**: Includes "2540", "160", "ASTM", "14B", "8006", or "108" in `ResultAnalyticalMethod.MethodName` or "00530", "80154", "70299", "70293", "69613", "69586", "69587", "69588", "69584", "69581", "69582", "69585", "69583", "69580", "69579", "70292" in `USGSPCode`.
+ **Have `ResultAnalyticalMethod.MethodName` values that are less reliable CDOM analytical methods**: Includes detection of "GCLAS", "I-3765-85", or "Nephelometry"
