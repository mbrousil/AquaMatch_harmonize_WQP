...
<img src="3_harmonize/out/cdom_stacked_char_names.png" alt="Stacked bar chart with counts of CharacteristicName records" width="650"/>
...
`Characteristics` field of the [Water Quality Portal Filter Results](https://www.waterqualitydata.us/#advanced=true) page. Note that "Absorbance" CharacteristicNames correspond to decadic absorption coefficient.
